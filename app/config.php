...
define("CDN", "https://cdn.sapancabungalovseyahat.com");
define("DOMAIN", "https://www.sapancabungalovseyahat.com");
//define("DOMAIN", "http://localhost:3000");
define("BASEAPI", "https://api.sapancabungalovseyahat.com");
define("PanelUrl","boceksoft-sbs");
...
return [
    'db' => [
        'name' => 'sapancabungalovseyahat',
        'host' => 'localhost',
        'user' => 'sapancabungalovseyahat',
        'pass' => 'sapancabungalovseyahat*-123'
    ],
    "lang" => "tr",
];
