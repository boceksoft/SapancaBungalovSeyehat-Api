...
//
//        $sql = "INSERT INTO sapancabungalovseyahat.dev_request_logs (request_endpoint, request_type, request_headers, created_date) VALUES (:request_endpoint, :request_type, :request_headers, :created_date)";
//        $params = [
