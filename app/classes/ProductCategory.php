...
class ProductCategory
{
    ...
    public static function Page($Routing)
    {
        ...
        $query = $db->prepare("
            ...
            inner join Routing r on r.EntityId=t.id and (r.RoutingTypeId='ProductCategory' or r.RoutingTypeId='ProductSearch') and r.site=1 
            where t.aktif=1 and t.favori=1 order by t.siralama asc
            ");
        $query->execute();

        $json["ProductCategories"]=array_map(function($item){
            return $item;
